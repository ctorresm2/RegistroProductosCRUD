...
namespace ProcesoCRUD.Presentacion
{
    public partial class Frm_Productos : Form
    {
        ...
        private void Formato_pr()
        {
            ...
            dgvListado_pr.Columns[0].HeaderText = "CODIGO";

            dgvListado_pr.Columns[1].Width = 220;
            dgvListado_pr.Columns[1].HeaderText = "DESCRIPCIÓN";

            dgvListado_pr.Columns[2].Width = 130;
            dgvListado_pr.Columns[2].HeaderText = "MARCA";

            dgvListado_pr.Columns[3].Width = 130;
            dgvListado_pr.Columns[3].HeaderText = "MEDIDA";

            dgvListado_pr.Columns[4].Width = 130;
        ...
        {
            this.nEstadoguarda = 2; //Actualizar registros
            this.EstadoTexto(true);
            this.EstadoBotones(false);
            txtDescripcion_pr.Select();
        }
        ...
        private void btnReporte_Click(object sender, EventArgs e)
        {
            ...
            oFrm_rpt.text_01.Text = txtBuscar.Text;
            oFrm_rpt.ShowDialog();
        }
    }
}
